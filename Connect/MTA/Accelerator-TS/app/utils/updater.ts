...
export async function Updater() {
    try {
        const response = await fetch('https://raw.githubusercontent.com/Dantas23/Eggs/main/Connect/MTA/Accelerator-TS/package.json');
        ...
        if (pkg.version === server.version) {
            ...
            if(process.env.AUTO_UPDATE) {
                try {
                    await download("https://github.com/Dantas23/Eggs/raw/main/Connect/MTA/Accelerator-TS/build/accelerator", "accelerator-update")
